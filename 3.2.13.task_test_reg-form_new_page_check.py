...
class TestRegs(unittest.TestCase):
    def base_code(self, link):
        ...
        self.assertEqual("Congratulations! You have successfully registered!" == welcome_text, "No Such Element Exception")
    ...
    def test_reg1(self):
        self.base_code("http://suninjuly.github.io/registration1.html")

    def test_reg2(self):
        self.base_code("http://suninjuly.github.io/registration2.html")
